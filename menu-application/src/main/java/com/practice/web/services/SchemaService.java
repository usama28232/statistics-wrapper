...
public class SchemaService {
    ...
    @LogSummaryPreview
    public Schema getStatsForSchema(String org, String key) {
        Schema request = new Schema();
        request.setOrg(org);
        request.setKey(key);
        Menu menuOption = this.menuService.getMenuOption(org, key);
        MenuDetail menuOptionDetail = this.menuDetailService.getMenuDetailEntity(org, key, this.lang);
